...
const Member = (props) => {
    ...
    const imgs = {
        "./img/cindy.jpg": require("./img/cindy.jpg"),
        "./img/keenan.jpg": require("./img/keenan.jpg"),
        "./img/anish.jpg": require("./img/anish.jpg"),
        "./img/elise.jpg": require("./img/elise.jpg")
    }
        ...
        <div className="column">
            <div className="team">
                <div className="team-img">
                    <img src={imgs[props.img]} alt="Team Image" />
                </div>
